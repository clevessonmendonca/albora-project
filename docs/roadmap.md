...
|---|---|---|---|
| **1 — convidado A** | A | A-01 Scanner · A-02 Missões · A-03 Minhas · A-04 Foto · A-05 Comentar · A-06 Denúncia · A-07 Fila · A-08 Música · A-09 Vazios | **Catálogo feito** · **Produto feito:** reentrada `/capa`, `NoSession` (≈ `SemEntrada`), fila global, hub capa, momentos→álbum, motivo na denúncia, CTA PWA 1ª foto, FloatingNav no álbum |
...
| **3 — pós-H1** | B | A-10 App · A-11 Parear · A-12 Recado · B-04 Missões editor · B-06 Moderação · B-07 Convidados · C-01 Vídeo parede | **Em curso** — B-04/B-06/B-07/A-11/A-12/C-01 no produto; falta app nativo (A-10) |
...
| A2 | **Botões do host: pânico + "há menores" + fila de revisão + gate** | **P/M** | **Feito** — admin + toggle de pânico no telão (`PATCH /api/wall/panic`; alias PT `/api/parede/panico`). |
...
| Classificador na thumb + fila de revisão no admin | [011](./specs/task-011-moderacao.md) — **parcial** (gate fail-closed na parede + fila; provedor é heurístico, sem ML) |
