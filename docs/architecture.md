...
| App nativo Expo | ADR 0008–0010, spec 017 | **Parcial** — câmera, fila, drain, feed, PUT background, Desenhista buffer (`processarFoto` + jpeg-js, strip EXIF); falta presets CSS/Skia, paridade de telas, lojas/EAS |
