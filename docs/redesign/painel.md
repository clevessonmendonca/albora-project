...
- **Depois** — **spec detalhada em `prototipos/posevento.html`** (rodada fechada). Princípio: **"Descubra a festa que você não conseguiu ver."** Experiência antes de tarefa. Ordem: hero de payoff ("Que noite 🤍 · 1.284 fotos por 96 pessoas", números tocáveis) → **Novas para você** (CTA principal, o gancho "183 chegaram depois que vocês foram embora") → **Reviver** narrativo (capítulos com horário + frase, e **tela final** compartilhável / vídeo 9:16) → **Momentos** → **Favoritas** → e só então **Guardar** (Baixar tudo / Destaques / Google Drive com status / Álbum-livro; "Incluído no plano Completo ✓", sem paywall pós-festa) → **Retenção visível** (timeline Hoje→dia 330 lembrete→dia 365 exclusão definitiva + "baixar agora") → **Cápsula de memória** (opt-in: guarda só ~20 destaques pras memórias anuais — resolve a contradição do delete em 1 ano). **Persona**: casal (ver álbum) vs assessoria (entregar). Nav no Depois: Início · Fotos · **Pessoas** · **Mais**.
