...
describe("gate de interação", () => {
  it("sem horário marcado, fica fechado para sempre", () => {
    // NULL é o padrão da coluna — um gate que abrisse sozinho por ausência de configuração abriria durante a cerimônia, o único momento em que o ADR 0009 garante que ele está fechado.
