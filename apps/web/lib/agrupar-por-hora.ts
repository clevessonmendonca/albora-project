...
export type ItemComInstante = { id: string; criadaEm: string | Date };

export type GrupoDeHora<T> = {
  /**
 ...
 */
export function agruparPorHora<T extends ItemComInstante>(
  itens: readonly T[],
...
export function rotuloDeHora(hora: number): string {
