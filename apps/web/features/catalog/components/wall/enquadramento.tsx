...
export function perfilEmPalavrasTelao(modelo: ModeloDeTelao): string {
...
export function notaDoModelo(modelo: ModeloDeTelao): string {
  return `${perfilEmPalavrasTelao(modelo)}. ${COMO_RESOLVE[modelo]}`;
}
...
export function Enquadramento({ modelo, mini }: { modelo: ModeloDeTelao; mini?: boolean }) {
  if (modelo === "cheio") {
