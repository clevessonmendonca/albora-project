...
/** Glifos Lucide inline (design-system-v3 §6): SVG com `currentColor`, nunca `<i data-lucide>`,
 *  para pintar certo sobre foto e no dark. Só os que o onboarding usa. O nome vem do pack
 *  (`pack.icone`) ou do próprio componente — não é palavra de domínio. */
