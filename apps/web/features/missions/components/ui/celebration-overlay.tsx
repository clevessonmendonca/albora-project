  ...
  return (
    <>
      <style>{`
        ...
        @keyframes celebBounce { 0% { transform:scale(0.4); opacity:0 } 60% { transform:scale(1.18); opacity:1 } 100% { transform:scale(1) } }
        ...
        .celeb-icon { animation:celebBounce .55s var(--mola) .2s both }
      ...
      >
        ...
        <p className="tipo-title tipo-balance mt-4 text-ink">
          Todas as missões
          <br />
          completas!
        </p>
        <p className="tipo-caption mt-2 text-ink-3">Toque para continuar</p>
