  ...
  return (
    <div className="flex min-h-[380px] flex-col items-center justify-center px-[calc(var(--espaco)*8)] py-[calc(var(--espaco)*12)] text-center">
      ...
      {!espelho && (
        <Link
          href={cameraPath}
          className="inline-flex min-h-[54px] items-center justify-center rounded-full bg-acento px-[calc(var(--espaco)*6)] font-corpo text-[0.9375rem] font-medium tracking-[0.05em] text-[var(--sobre-acento)] transition-transform duration-[var(--tempo-micro)] hover:scale-[0.977] active:scale-[0.977]"
        >
          Tirar foto
        </Link>
      )}
