/** Extrai a primeira família de uma stack CSS (`Fraunces, Georgia, serif`). Skia `matchFont` usa uma família por vez — o resto fica como fallback do SO. */
...
/** Mapeia stacks licenciadas do resolvedor para as faces OFL embutidas no app. `var(...)` deve ser resolvido antes (ex.: `paletteForFrame`). */
